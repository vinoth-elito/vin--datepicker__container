        ...
        function dragKnob(knobType) {
            ...
            $svg.addEventListener("mousemove", e => {
                ...
                if (knobType === "hour") {
                    ...
                    $popup.find(`.circle-hour[data-hour='${hour}']`).addClass("vintimepicker--selected__hour");
                    ...
                    $popup.find(`.vintimepicker--circle__minute[data-minute='${Math.round(minute / 5) * 5}']`).addClass("vintimepicker--selected__minute");
